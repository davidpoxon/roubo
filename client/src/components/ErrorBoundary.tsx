...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  render(): ReactNode {
    ...
    return (
      ...
      >
        <div className="max-w-md w-full rounded-xl border border-border bg-bg-surface p-6 shadow-sm">
          <div className="flex items-center gap-2.5 mb-3">
            <div className="flex items-center justify-center w-7 h-7 rounded-md bg-accent-muted text-accent-text shrink-0">
              <AlertTriangle size={16} aria-hidden />
            </div>
            <h2 className="text-16 font-semibold text-text-primary">Something went wrong{area}</h2>
          </div>

          <p className="text-13 text-text-body leading-relaxed mb-4">
          ...
          <pre className="text-11 font-mono text-text-secondary bg-bg-base rounded-lg p-3 mb-4 overflow-auto max-h-32 whitespace-pre-wrap break-words">
          ...
          <div className="flex justify-end">
            <Button
              ...
              className="px-4 py-2 text-13 font-medium rounded-control bg-accent text-on-accent hover:bg-accent-hover active:bg-accent-active transition-colors outline-none data-[focus-visible]:ring-2 data-[focus-visible]:ring-focus-ring"
            >
              Reload
            </Button>
          </div>
