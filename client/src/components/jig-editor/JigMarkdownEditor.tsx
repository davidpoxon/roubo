...
export interface JigMarkdownEditorRef {
...
const JigMarkdownEditor = forwardRef<JigMarkdownEditorRef, Props>(function JigMarkdownEditor(
  ...
  const ariaLabelRef = useRef(ariaLabel ?? "Jig content editor");
  const initialValueRef = useRef(value);
  const themeCompartment = useRef(new Compartment());
  const suppressEcho = useRef(false);

  onChangeRef.current = onChange;
  ariaLabelRef.current = ariaLabel ?? "Jig content editor";
...
export default JigMarkdownEditor;
