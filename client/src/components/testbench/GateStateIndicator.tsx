...
// keeps its own token map reusing the same DESIGN.md palette:
...
//   no_gating_cases -> stone-700   (neutral stone, reused from stale: it is NOT a
...
const GATE_DOT: Record<GateStatus, string> = {
  ...
  no_gating_cases: "bg-stone-700 dark:bg-stone-400",
};
...
const GATE_TEXT: Record<GateStatus, string> = {
  ...
  no_gating_cases: "text-stone-700 dark:text-stone-300",
};
