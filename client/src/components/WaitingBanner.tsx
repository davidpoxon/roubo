 ...
 * strip at the top of the pane, with the accent action-needed treatment
...
export default function WaitingBanner() {
  return (
    <div
      ...
      role="status"
    >
      <span className="size-1.5 rounded-full bg-accent animate-status-pulse shrink-0" />
      <span className="text-12 font-mono text-text-body">Waiting for your input</span>
    </div>
  );
}
