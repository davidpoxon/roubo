// Types for `argv-log-path.mjs`. That module is plain ESM rather than TypeScript
// because the extensionless stub binaries load it off disk with no build step, so
