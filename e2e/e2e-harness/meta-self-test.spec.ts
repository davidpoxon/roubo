...
// IP-TC-181 (IP-US-025, IP-FR-077, IP-FR-078, IP-FR-080, IP-NFR-018): the harness's own
...
//   - IP-TC-176 (IP-WU-067) covers in-process determinism at the JSON-RPC layer
//     (e2e/fixtures/stubbed-plugin/src/__tests__/determinism.test.ts).
//   - IP-TC-177 (IP-WU-068) covers the /test/__reset 404 gate when ROUBO_E2E is
