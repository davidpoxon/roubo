...
// the stubbed-plugin journal and survive a page reload. IP-WU-064 (#237) shipped
// IP-TC-168 and IP-TC-169 but never automated IP-TC-162; #264 closes that gap.
//
...
// made for project registration (#249).
