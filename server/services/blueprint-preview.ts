...
import type { BlueprintResolveContext } from "./blueprint-manager.js";

export function getSampleResolveContext(): BlueprintResolveContext {
  return {
...
export async function buildPreviewContext(
  ...
  bench: Bench,
): Promise<BlueprintResolveContext> {
  ...
  let issueCtx: Partial<BlueprintResolveContext> = {};
