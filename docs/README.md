...
- **[Plugin Author Guide](./plugin-sdk.md)**: writing an integration, component, or agent plugin against `@roubo/plugin-sdk`. The manifest format, the contract methods, the agent contract and its launch descriptor, host helpers, and the trust model.
