...
- Turning an override on seeds the field with the app default it replaces, so switching a field to overridden never silently changes what launches. Turning it off again drops the override and the field goes straight back to inheriting.
